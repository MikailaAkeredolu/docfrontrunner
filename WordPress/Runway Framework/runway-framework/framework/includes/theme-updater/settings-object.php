	...
	function update_extensions_block() {
		...
		if($theme_info['type'] == 'child') {
			...
			<?php wp_nonce_field('upgrade-core'); ?>
				<p><input id="upgrade-themes" class="button" type="submit" value="<?php echo esc_attr('Update Extensions', 'framework'); ?>" name="upgrade" /></p>
				...
				<p><input id="upgrade-themes-2" class="button" type="submit" value="<?php echo esc_attr('Update Extensions', 'framework'); ?>" name="upgrade" /></p>
			</form>
